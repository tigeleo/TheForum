...
export const DATA_USERS = [
                    ...
                    {id:3,username:'MisterA',password:'POFMisterA',firstname:'Sharik',lastname:'Mosharik',role:'User'},
                    {id:3,username:'MisterB',password:'POFMisterB',firstname:'Pif',lastname:'Hrif',role:'User'},
                    {id:3,username:'MisterC',password:'POFMisterC',firstname:'Vasia',lastname:'Bublik',role:'User'},
                    {id:3,username:'MisterD',password:'POFMisterD',firstname:'Don',lastname:'Juan',role:'User'},
                    {id:3,username:'MisterE',password:'POFMisterE',firstname:'Tom',lastname:'Henks',role:'User'},
                    {id:3,username:'MisterF',password:'POFMisterF',firstname:'Sandra',lastname:'Bolbok',role:'User'},
                    {id:3,username:'MisterJ',password:'POFMisterJ',firstname:'Alla',lastname:'Pugachurva',role:'User'},
                    {id:3,username:'MisterI',password:'POFMisterI',firstname:'Tania',lastname:'Killer',role:'User'},
                    {id:3,username:'MisterK',password:'POFMisterK',firstname:'Blond',lastname:'InShokolad',role:'User'},
                    {id:3,username:'MisterL',password:'POFMisterL',firstname:'Tonia',lastname:'Spok',role:'User'},
                    {id:3,username:'MisterM',password:'POFMisterM',firstname:'Glaz',lastname:'Udav',role:'User'},
                    {id:3,username:'MisterN',password:'POFMisterN',firstname:'Nos',lastname:'Pendos',role:'User'},
                    {id:3,username:'MisterO',password:'POFMisterO',firstname:'Ruka',lastname:'Litso',role:'User'},
                    {id:3,username:'MisterQ',password:'POFMisterQ',firstname:'Abirvalg',lastname:'Asuleiman',role:'User'},
                    {id:3,username:'MisterP',password:'POFMisterP',firstname:'Zorro',lastname:'Bandoro',role:'User'},
                    {id:3,username:'MisterR',password:'POFMisterR',firstname:'Welish',lastname:'Scotish',role:'User'},
                    {id:3,username:'MisterS',password:'POFMisterS',firstname:'Ilia',lastname:'Muromets',role:'User'},
                    {id:3,username:'MisterT',password:'POFMisterT',firstname:'Alex',lastname:'Popovitch',role:'User'},
                    {id:3,username:'MisterU',password:'POFMisterU',firstname:'Dobi',lastname:'Nikitich',role:'User'},
